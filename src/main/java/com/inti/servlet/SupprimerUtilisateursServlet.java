...
/**
 * Servlet implementation class SupprimerUtilisateursServlet
 */
@WebServlet("/supprimerUtilisateur")
public class SupprimerUtilisateursServlet extends HttpServlet {
     ...
     */
    public SupprimerUtilisateursServlet() {
        super();
